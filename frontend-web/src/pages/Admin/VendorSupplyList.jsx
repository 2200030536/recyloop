...
import { FiArrowLeft, FiTruck, FiTrash2, FiEdit2, FiFilter, FiCheckCircle } from 'react-icons/fi';
import api from '../../services/api';
import { useToast } from '../../context/ToastContext';
import ConfirmDialog from '../../components/ConfirmDialog';

const VendorSupplyList = () => {
    ...
    const fetchSupplies = async () => {
        try {
            const response = await api.get('/admin/vendor-supply');
    ...
    const handleDeleteSupply = async (id) => {
        try {
            await api.delete(`/admin/vendor-supply/${id}`);
            fetchSupplies();
    ...
    const handleUpdateStatus = async (e) => {
        e.preventDefault();
        try {
            await api.put(`/admin/vendor-supply/${updateModal._id}/status`, {
    ...
    const filteredSupplies = supplies.filter(item => {
        ...
        return vendorMatch && cityMatch && productMatch && statusMatch;
    }).sort((a, b) => {
        ...
        <div className="page-container">
            ...
            {confirmDelete && (
                <ConfirmDialog
                    ...
                    confirmText="Delete"
                    danger
                    onConfirm={() => { handleDeleteSupply(confirmDelete._id); setConfirmDelete(null); }}
...
export default VendorSupplyList;
