...
import { FiArrowLeft, FiBox, FiEdit2, FiFilter, FiCheckCircle } from 'react-icons/fi';
import api from '../../services/api';
import { useToast } from '../../context/ToastContext';

const CityAdminRecyclerDemandList = () => {
    ...
    const fetchDemands = async () => {
        try {
            const response = await api.get('/city-admin/recycler-demand');
    ...
    const handleUpdateStatus = async (e) => {
        e.preventDefault();
        try {
            await api.put(`/city-admin/recycler-demand/${updateModal._id}/status`, {
    ...
    const filteredDemands = demands.filter(item => {
        ...
        return recyclerMatch && productMatch && statusMatch;
    }).sort((a, b) => {
...
export default CityAdminRecyclerDemandList;
